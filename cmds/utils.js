                ...
                let e = {
                    ...
                    fields: [
                        ...
                        },
                        {
                            ...
                            value: `${u.game.emoji && ctx.emotes.get(u.game.emoji.id) ? `<${u.game.emoji.animated ? "a" : ""}:_:${u.game.emoji.id}> ` : ""}${u.game ? u.game.name : (u.game.emoji ? (ctx.emotes.get(u.game.emoji.id) ? "" : "<bot doesnt have emote>") : "Nothing")}`,
                            inline: true
                        },
                        {
                            name: "Roles",
