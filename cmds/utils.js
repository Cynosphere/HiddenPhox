                ...
                let e = {
                    ...
                    fields: [
                        ...
                        },
                        {
                            ...
                            value: `${u.game.emoji && ctx.emotes.get(u.game.emoji.id) ? `<${u.game.emoji.animated ? "a" : ""}:_:${u.game.emoji.id}> ` : ""}${u.game ? (u.game.type == 4 ? (u.game.state ? u.game.state : (ctx.emotes.get(u.game.emoji.id) ? "" : "<bot doesnt have emote> ")) : u.game.name) : "Nothing"}`,
                            inline: true
                        },
                        {
                            name: "Roles",
